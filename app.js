...
app.use((req, res, next) =>{
	...
	res.header('Access-Control-Allow-Headers', 'Authorization, X-API-KEY, Origin, X-Requested-With, Conten-Type, Accept, Access-Control-Allow-Request-Method'); //cabeceras
